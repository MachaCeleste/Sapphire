...
class ManSea003 : public Sapphire::ScriptAPI::QuestScript
{
  ...
  {
    eventMgr().playQuestScene( player, getId(), 1, FADE_OUT | HIDE_UI, bindSceneReturn( &ManSea003::Scene00001Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 2, NONE, bindSceneReturn( &ManSea003::Scene00002Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 3, FADE_OUT | HIDE_UI, bindSceneReturn( &ManSea003::Scene00003Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 4, NONE, bindSceneReturn( &ManSea003::Scene00004Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 5, FADE_OUT | HIDE_UI, bindSceneReturn( &ManSea003::Scene00005Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 6, NONE, bindSceneReturn( &ManSea003::Scene00006Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 7, FADE_OUT | HIDE_UI, bindSceneReturn( &ManSea003::Scene00007Return ) );
  }
